...
var router = express.Router(); // aqui voy a requerir mi modelo creado , en
// este caso fue el modelo Empresa

var PRODUCTOS = require('../models/m_producto'); // Definimos las rutas::
...
router.post("/", /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, codigo, nombre, stock, costo, descripcion, precio, response;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _req$body = req.body, codigo = _req$body.codigo, nombre = _req$body.nombre, stock = _req$body.stock, costo = _req$body.costo, descripcion = _req$body.descripcion, precio = _req$body.precio;
            _context2.next = 4;
